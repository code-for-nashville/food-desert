...
export PGPASSWORD=bren2736
export PGDATABASE=geocoder
PSQL=${PGBIN}/psql
SHP2PGSQL=shp2pgsql

cd /home/bren/gisdata
wget http://www2.census.gov/geo/tiger/TIGER2016/STATE/tl_2016_us_state.zip --mirror --reject=html

cd /home/bren/gisdata/www2.census.gov/geo/tiger/TIGER2016/STATE
rm -f ${TMPDIR}/*.*
...
cd /home/bren/gisdata/www2.census.gov/geo/tiger/TIGER2016/COUNTY
rm -f ${TMPDIR}/*.*
${PSQL} -c "DROP SCHEMA IF EXISTS tiger_staging CASCADE;"
${PSQL} -c "CREATE SCHEMA tiger_staging;"
